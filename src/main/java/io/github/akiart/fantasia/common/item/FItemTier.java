...
public class FItemTier implements IItemTier {
    ...
    public static final FItemTier FROSTWORK = new FItemTier(5, 340, 6.0f, 2.5f, 30, () -> Ingredient.EMPTY);
    public static final FItemTier GHASTLY = new FItemTier(2, 1561, 6.0f, 2f, 30, () -> Ingredient.of(Items.APPLE));
    public static final FItemTier BONE = new FItemTier(2, 1561, 6.0f, 2f, 30, () -> Ingredient.of(Items.APPLE));
