...
public class FBlockPlacerTypes {
    ...
    public static final RegistryObject<BlockPlacerType<StalactiteBlockPlacer>> STALACTITE_BLOCK_PLACER = BLOCK_PLACER_TYPES.register("stalactite_block_placer", () -> new BlockPlacerType<>(StalactiteBlockPlacer.CODEC));
    ...
    public static final RegistryObject<BlockPlacerType<ColumnBlockPlacer>> COLUMN_BLOCK_PLACER = BLOCK_PLACER_TYPES.register("column_block_placer", () -> new BlockPlacerType<>(ColumnBlockPlacer.CODEC));
}
